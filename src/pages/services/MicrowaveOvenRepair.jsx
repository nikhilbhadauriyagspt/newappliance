        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <img src="/service-8.jpg" className="rounded-3xl shadow-2xl w-full object-cover max-h-[600px]" alt="Microwave Oven Repair" />
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-6xl font-heading font-bold text-gray-900 mb-8 leading-tight">Microwave Oven Repair</h1>
            <p className="text-xl text-primary font-medium mb-6 leading-relaxed">Quick fixes for heating issues and sparking in all microwave brands.</p>
            <div className="prose prose-lg text-gray-500 mb-10 max-w-none">
              <p>A microwave is essential for modern kitchens. We fix common issues like magnetron failures, sparking, touch panel non-responsiveness, and turntable motor problems to get your kitchen back in order.</p>
            </div>
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {["Magnetron fix", "Touch pad repair", "Diode replacement", "Fuse check"].map((feature, index) => (
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <button onClick={() => openBookingModal('Microwave Oven')} className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white px-10 py-5 rounded-2xl font-bold uppercase tracking-widest shadow-xl hover:-translate-y-1 transition-all text-center">Book Service Now</button>
