      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-8">
          ...
          <section>
            ...
            <p>
              You can contact us by phone at +1-402-508-9991, email at <a href="mailto:appliancevista@outlook.com" className="text-primary">appliancevista@outlook.com</a>, or by
