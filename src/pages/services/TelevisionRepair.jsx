        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <img src="/service-4.jpg" className="rounded-3xl shadow-2xl w-full object-cover max-h-[600px]" alt="Television Repair" />
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <button onClick={() => openBookingModal('Television')} className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white px-10 py-5 rounded-2xl font-bold uppercase tracking-widest shadow-xl hover:-translate-y-1 transition-all text-center">Book Service Now</button>
