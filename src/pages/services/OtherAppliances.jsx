...
const OtherAppliances = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24">
      <Helmet>
        <title>Other Appliances Repair - Appliance Vista Services</title>
        <meta name="description" content="Microwaves, ovens, dryers, and more. If it's broken, we can likely fix it." />
      </Helmet>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <img src="/service-6.jpg" className="rounded-3xl shadow-2xl w-full object-cover max-h-[600px]" alt="Other Appliances Repair" />
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-6xl font-heading font-bold text-gray-900 mb-8 leading-tight">Other Appliances Repair</h1>
            <p className="text-xl text-primary font-medium mb-6 leading-relaxed">Microwaves, ovens, dryers, and more. If it's broken, we can likely fix it.</p>
            <div className="prose prose-lg text-gray-500 mb-10 max-w-none">
              <p>Our expertise extends beyond the basics. We also repair microwaves, ovens, stoves, dryers, and other small to large household appliances. Trust us for a one-stop solution for all your home appliance needs.</p>
            </div>
            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 mb-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {["Microwave magnetron replacement", "Oven heating element fix", "Dryer belt and motor repair", "Stove burner troubleshooting"].map((feature, index) => (
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <button onClick={() => openBookingModal('Appliances')} className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white px-10 py-5 rounded-2xl font-bold uppercase tracking-widest shadow-xl hover:-translate-y-1 transition-all text-center">Book Service Now</button>
