        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <img src="/service-1.jpg" className="rounded-3xl shadow-2xl w-full object-cover max-h-[600px]" alt="Washing Machine Repair" />
          ...
          <div className="w-full lg:w-1/2">
            <h6 className="text-secondary font-bold uppercase tracking-widest text-sm mb-4">Top-Rated Service</h6>
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-8 leading-tight">Professional Washing Machine Repair</h1>
            <p className="text-xl text-primary font-medium mb-6 leading-relaxed">
              Fast, reliable, and affordable repair services for all washing machine brands and models.
            </p>
            ...
            <div className="prose prose-lg text-gray-500 mb-10 max-w-none">
              ...
              <h3 className="text-gray-900 font-bold text-xl mt-6 mb-3">Common Issues We Fix:</h3>
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Drainage Problems:</strong> Water not draining or draining slowly.</li>
                <li><strong>Spinning Issues:</strong> Drum not spinning or making loud noises.</li>
                <li><strong>Water Leakage:</strong> Leaks from the door or bottom of the machine.</li>
                <li><strong>Start-up Failures:</strong> Machine not turning on or stopping mid-cycle.</li>
                <li><strong>Vibration & Noise:</strong> Excessive shaking or unusual sounds during operation.</li>
              </ul>
            </div>

            <div className="bg-gray-50 rounded-3xl p-8 border border-gray-100 mb-10">
              <h5 className="font-bold text-xl text-gray-900 mb-6 flex items-center gap-3"><FaTools className="text-secondary" /> Why Choose Us?</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {["Certified Technicians", "Genuine Spare Parts", "Same-Day Service", "Transparent Pricing", "Warranty on Repairs", "24/7 Customer Support"].map((feature, index) => (
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <button onClick={() => openBookingModal('Washing Machine')} className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white px-10 py-5 rounded-2xl font-bold uppercase tracking-widest shadow-xl hover:-translate-y-1 transition-all text-center">Book Repair Now</button>
              <div className="flex items-center gap-3 text-gray-500 font-bold"><FaRegClock className="text-secondary" /><span>Technician arrives in 2 hours</span></div>
            </div>
          </div>
        </div>
      </div>
